...
import MainComponent01 from './itemBox01Component'
import MainComponent02 from './itemBox02Component'
...
function Content() {
  return (
    <div>
        ...
        <div class="row">
            <div class="column">
                <h1 className='heading01'>The multichain <br/> vision for Web3 <br/> starts here.</h1>
                <p className='paragraph01'>Polkadot unites and secures a growing ecosystem of specialized blockchains called parachains. Apps and <br/> services on Polkadot can securely communicate across <br/> chains, forming the basis for a truly interoperable decentralized web.</p>
                <button class="button button1">Learn Parachains</button>
                <button class="button button2">Learn Cross-Chain</button>
            </div>
            <div class="column">
                <a href="#">
